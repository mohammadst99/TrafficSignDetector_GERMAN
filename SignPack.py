...
path = "sources/myData"  # folder with all the class folders
labelFile = 'sources/labels.csv'  # file with all names of classes
...
pickle_out = open("sources/model_trained.p", "wb")  # wb = WRITE BYTE
